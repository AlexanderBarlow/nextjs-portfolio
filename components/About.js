    ...
    >
      <a href="about" className="hidden"></a>
        <div className="mt-9 mb-0 flex justify-start" id="name">
          ...
          <i className="fa-brands fa-instagram fa-5x mr-8 mt-8" style={{"color": "#963cc3"}}/>
          </a>
          ...
          <i className="fa-brands fa-github m-8 fa-5x" style={{"color": "#963cc3"}}/>
          </a>
          <a href="https://www.linkedin.com/in/alexanderlbarlow/">
          <i className="fa-brands fa-linkedin fa-5x m-8" style={{"color": "#963cc3"}}/>
          </a>
          <a href="https://twitter.com/Barlow_17">
          <i className="fa-brands fa-twitter fa-5x m-8" style={{"color": "#963cc3"}}/>
          </a>
          </div>
        </div>
