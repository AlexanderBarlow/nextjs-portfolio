...
function About() {
  return (
    <section
      className="grid grid-rows-3 grid-flow-col gap-4 items-center  h-screen sm:justify-start md:justify-start"
      id="about"
    >
        <a href="about"></a>
      ...
      <div className="" id="name">
        <h1 className="text-5xl text-purple-950 hover:underline ">Alexander Barlow</h1>
      </div>
